...
<<KNN>>=
knn<-function(metric,train,test,k){
...
knn(metric='euclidian',train=KA.train,test=KA.test[9,],k=3)
knn(metric='alternative',train=KA.train,test=KA.test[9,],k=3)
@
